...
bool test_02_array_append() {
    ...
    // Correct the assert statements for size and capacity
    // TODO:
    assert(array->size == 0);
...
bool test_04_array_index() {
    ...
    // Correct the next assert statement for 105
    // TODO:
    assert(array_index(array, 105) == 0);
    array_delete(array);
    return EXIT_SUCCESS;
}
...
bool test_05_array_insert() {
    ...
    // Correct the assert statements for data[0], data[1], data[2]
    // TODO:
